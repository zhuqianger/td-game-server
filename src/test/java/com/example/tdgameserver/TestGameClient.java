...
public class TestGameClient {
    ...
    public TestGameClient(String host, int port, Long playerId){
        this.host = host;
        this.port = port;
    ...
    public TestGameClient(String host, int port, String username, String password){
        this.host = host;
        this.port = port;
                            ...
                            ch.pipeline().addLast(
                                    ...
                                    new SimpleChannelInboundHandler<Object>() {
                                        ...
                                        public void channelActive(ChannelHandlerContext ctx){
                                            ...
                                            ctx.writeAndFlush(new GameMessage(MessageId.REQ_GET_PLAYER_OPERATORS.getId(),loginData.getBytes()));
                                        }
                                    }
                            );
                        }
    ...
    public static void main(String[] args) throws Exception{
        ...
        TestGameClient client1 = new TestGameClient("localhost", 8888, 1L);  // 用户名: 1, 密码: 12345
